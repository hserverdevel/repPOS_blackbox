...
public class ClientsActivity extends AppCompatActivity implements HttpHandler.AsyncResponse {
    ...
    public CustomButton getDiscountButton(){return setDiscount;}
    private CustomButton setClientType;
    public CustomButton getClientButton(){return setClientType;}

    private ImageButton add_fidelity_credit_bt;
    ...
    public int getCurrentClientId(){return currentClientId;}
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        fidelity_code_text = findViewById(R.id.add_fidelity_code);

        // the button to buy fidelity package. It can be used only after a client has been selected
        // (in `openModifyMode`)
        add_fidelity_credit_bt = (ImageButton) findViewById(R.id.add_fidelity_credit_button);
        add_fidelity_credit_bt.setEnabled(false);
        show_fidelity_credit = findViewById(R.id.show_fidelity_credit);
                ...
                switch (route) {
                    ...
                    case "updateClient":
                        ...
                        if (check)
                        {
                            ...
                            {Toast.makeText(context, getString(R.string.route_check_false, route, jsonObject.getString("reason")), Toast.LENGTH_LONG).show(); }
                    ...
                    case "insertClient":
                        ...
                        if (check)
                        {
                            ...
                            dbA.insertFidelitySync(new ArrayList<Fidelity>() {{ add(f); }});
                    ...
                    case "insertClientWithCompany":
                        ...
                        if (check) {
                                ...
                                dbA.insertFidelitySync(new ArrayList<Fidelity>((Collection<? extends Fidelity>) f));
    ...
    public void clientPopup(String title, String hint, int value)
    {
        ...
        final View popupView = inflater.inflate(R.layout.client_type_popup, null);
    ...
    public void setupButtons()
    {
        ...
        addNewClient.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                String name = ((CustomEditText)findViewById(R.id.name_et)).getText().toString().trim().replaceAll("'","\'");
                String surname = ((CustomEditText)findViewById(R.id.surname_et)).getText().toString().trim().replaceAll("'","\'");
                String email = ((CustomEditText)findViewById(R.id.email_et)).getText().toString().trim().replaceAll("'","\'");
                ...
                {
                    String company_name = ((CustomEditText)findViewById(R.id.company_name_et)).getText().toString().replaceAll("'","\'");
                    company_name = company_name.replaceAll("'", "''");
                    String vat_number = ((CustomEditText)findViewById(R.id.vat_number_et)).getText().toString().replaceAll("'","\'");
                    String address = (((CustomEditText)findViewById(R.id.address_et)).getText().toString()).replaceAll("'","\'");
                    address = address.replaceAll("'", "''");

                    String postal_code = ((CustomEditText)findViewById(R.id.postal_code_et)).getText().toString().replace("'","\'");
                    String country = ((CustomEditText)findViewById(R.id.country_et)).getText().toString().replaceAll("'","\'");
                    country = country.replaceAll("'", "''");

                    String city = ((CustomEditText)findViewById(R.id.city_et)).getText().toString().replaceAll("'","\'");
                    city = city.replaceAll("'", "''");

                    String codicefiscale = "";
                    String provincia = ((CustomEditText)findViewById(R.id.provincia_et)).getText().toString().replaceAll("'","\'");
                    String codiceDestinatario= ((CustomEditText)findViewById(R.id.codice_destinatario_et)).getText().toString().replaceAll("'","\'");
                    String pec = ((CustomEditText)findViewById(R.id.pec_et)).getText().toString().replaceAll("'","\'");
                                            ...
                                            if (mode == MODIFY_MODE)
                                            {
                                                if(StaticValue.blackbox)
                                                {
                                                    ...
                                                    if (getDiscountButton().isActivated())
                                                        params.add(new BasicNameValuePair("discountButton", getDiscountButton().getText().toString().toLowerCase()));
                                                    else
                                                        params.add(new BasicNameValuePair("discountButton", String.valueOf(-1)));
                                                    if (getClientButton().isActivated())
                                                        params.add(new BasicNameValuePair("clientButton", getClientButton().getText().toString().toLowerCase()));
                                                    else
                                                        params.add(new BasicNameValuePair("clientButton", String.valueOf(-1)));
                                                    params.add(new BasicNameValuePair("id", String.valueOf(currentClient.getClient_id())));

                                                    params.add(new BasicNameValuePair("companyId", String.valueOf(currentClient.getCompany_id())));
                ...
                {
                    String company_name = "";
                    String vat_number = ((CustomEditText)findViewById(R.id.vat_number_et_p)).getText().toString().replaceAll("'","\'");
                    String address = (((CustomEditText)findViewById(R.id.address_et_p)).getText().toString()).replaceAll("'","\'");
                    address = address.replaceAll("'", "''");
                    String postal_code = ((CustomEditText)findViewById(R.id.postal_code_et_p)).getText().toString().replace("'","\'");
                    String country = ((CustomEditText)findViewById(R.id.country_et_p)).getText().toString().replaceAll("'","\'");
                    country = country.replaceAll("'", "''");
                    String city = ((CustomEditText)findViewById(R.id.city_et_p)).getText().toString().replaceAll("'","\'");
                    city = city.replaceAll("'", "''");
                    String codicefiscale = ((CustomEditText)findViewById(R.id.codice_fiscale_et_p)).getText().toString().replaceAll("'","\'");
                    String provincia = ((CustomEditText)findViewById(R.id.provincia_et_p)).getText().toString().replaceAll("'","\'");
                    String codiceDestinatario= ((CustomEditText)findViewById(R.id.codice_destinatario_et_p)).getText().toString().replaceAll("'","\'");
                    String pec = ((CustomEditText)findViewById(R.id.pec_et_p)).getText().toString().replaceAll("'","\'");
                        ...
                        if (!Pattern.matches("^[-a-zA-Z0-9_.\\-]+@[a-zA-Z0-9_.\\-]+\\.[a-zA-Z]{2,5}$", email)) {
                            ...
                            if (mode != MODIFY_MODE) {
                                if(!StaticValue.blackbox) {
                                    ...
                                    if (client_id == -1) {
                                        findViewById(R.id.email_et).startAnimation(shake);
                                        Toast.makeText(ClientsActivity.this, R.string.client_already_present, Toast.LENGTH_SHORT).show();
                                    } else {
                                        if (getDiscountButton().isActivated()) {
                                            if (!dbA.checkIfClientHasASingleDiscount(client_id,
                                                    getDiscountButton().getText().toString().toLowerCase())) {
                                                dbA.assignDiscountToClient(client_id, getDiscountButton().getText().toString().toLowerCase());
                                        ...
                                        if (getClientButton().isActivated()) {
                                            if (!dbA.checkIfClientHasASingleDiscount(client_id,
                                                    getClientButton().getText().toString().toLowerCase())) {
                                                dbA.assignDiscountToClient(client_id, getClientButton().getText().toString().toLowerCase());
                                ...
                                if(StaticValue.blackbox){
                                    ...
                                    dbA.updateClientData(currentClient);
                                    if (!clientsAdapter.searchMode) clientsAdapter.updateDataSet();
                                    closeModifyMode();
                                }
                            }
                        }
            ...
            public void onClick(View v) {
                ...
                if (mode != MODIFY_MODE) {
                    ...
                    if(v.isActivated()){
                        ...
                        ClientsActivity.this.findViewById(R.id.title_tv).setVisibility(View.INVISIBLE);
                        ClientsActivity.this.findViewById(R.id.hline_rv_top).setVisibility(View.INVISIBLE);
                        ...
                        mode = COSTUMER_MODE;
                        ClientsActivity.this.findViewById(R.id.title_tv).setVisibility(View.VISIBLE);
                        ClientsActivity.this.findViewById(R.id.hline_rv_top).setVisibility(View.VISIBLE);
        ...
        setClientType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(setClientType.isActivated()) {
                    int value = dbA.getDiscountValue(setClientType.getText().toString().toLowerCase());
                ...
                if(setClientType.isActivated()){
                    if(currentClient != null) {
                        dbA.deleteSpecificClientDiscount(currentClient.getClient_id(),
                                setClientType.getText().toString().toLowerCase());
                    }
                ...
                switch (mode){
                    ...
                    case 1 :
                        ...
                        if(sender!=null) {
                            ...
                            else intentToGo.putExtra("customer",-1);
                            if(clientLongClick)
                    ...
                    case 4:
                        ...
                        if(currentClient == null){
                            ...
                            if(currentClient.getCompany_id() == -1){
                                String name = ((CustomEditText)findViewById(R.id.name_et)).getText().toString().replaceAll("'","\'");
                                String surname = ((CustomEditText)findViewById(R.id.surname_et)).getText().toString().replaceAll("'","\'");
                                String email = ((CustomEditText)findViewById(R.id.email_et)).getText().toString().replaceAll("'","\'");
                                String company_name = ((CustomEditText)findViewById(R.id.company_name_et)).getText().toString().replaceAll("'","\'");
                                company_name = company_name.replaceAll("'", "''");
                                String vat_number = ((CustomEditText)findViewById(R.id.vat_number_et)).getText().toString().replaceAll("'","\'");
                                String address = (((CustomEditText)findViewById(R.id.address_et)).getText().toString()).replaceAll("'","\'");
                                ...
                                String codicefiscale = "";
                                String provincia = ((CustomEditText)findViewById(R.id.provincia_et)).getText().toString().replaceAll("'","\'");
                                String codice_destinatario= ((CustomEditText)findViewById(R.id.codice_destinatario_et)).getText().toString().replaceAll("'","\'");
                                String pec= ((CustomEditText)findViewById(R.id.pec_et)).getText().toString().replaceAll("'","\'");
                                ...
                                if(!company_name.equals("") &&
                                    ...
                                    if (!company_name.equals("")) {
                                        if (!vat_number.equals("") && vat_number.length()==11) {
                                            if ((!codice_destinatario.equals("") && codice_destinatario.length() == 7) || (!pec.equals("") && pec.length() > 1)) {
                                                if(!name.equals("")||!email.equals("")||!surname.equals("")){
                                                    if(!email.equals("")){
                                            ...
                                            httpHandler.execute();*/
                                                    ...
                                                    if(!clientsAdapter.searchMode)
                                                        clientsAdapter.updateDataSet();
                                                    closeModifyMode();
                                                    Toast.makeText(ClientsActivity.this, R.string.client_updated, Toast.LENGTH_SHORT).show();
                                                } else {
                                                    if (email.equals("") )
                                                        findViewById(R.id.email_et).startAnimation(shake);
                                                    if (name.equals("") )
                                             ...
                                             */   }
                                                ...
                                                if((codice_destinatario.equals("") || codice_destinatario.length()!=7)){
                                                    findViewById(R.id.codice_destinatario_et).startAnimation(shake);
                                                }else {
                                                    findViewById(R.id.pec_et).startAnimation(shake);
                                                }
...
/*
                                ...
                                if(!company_name.equals("") &&
                                        ...
                                        if (!vat_number.equals("") && vat_number.length()==11) {
                                            if ((!codice_destinatario.equals("") && codice_destinatario.length() == 7) || (!pec.equals("") && pec.length() > 1)) {
                                                if(!name.equals("")||!email.equals("")||!surname.equals("")){
                                                    ...
                                                    else myIntent.putExtra("customer",-1);
                                  ...
                                  */  }
                                    ...
                                    findViewById(R.id.client_info_container).startAnimation(shake);
                                    Toast.makeText(ClientsActivity.this,"empty field", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                        else if(currentClient.getCompany_id() == -1){
                            Toast.makeText(ClientsActivity.this, R.string.vat_number_must_be_declared, Toast.LENGTH_SHORT).show();
                        }else if(addPersonalInfo.isActivated()) {
                            if (currentClient.getCompany_id() == -1) {
                                String name = ((CustomEditText) findViewById(R.id.name_et)).getText().toString().replaceAll("'", "\'");
                                String surname = ((CustomEditText) findViewById(R.id.surname_et)).getText().toString().replaceAll("'", "\'");
                                ...
                                String codicefiscale = ((CustomEditText) findViewById(R.id.codice_fiscale_et_p)).getText().toString().replaceAll("'", "\'");
                                String provincia = ((CustomEditText) findViewById(R.id.provincia_et_p)).getText().toString().replaceAll("'", "\'");
                                String codice_destinatario = ((CustomEditText) findViewById(R.id.codice_destinatario_et_p)).getText().toString().replaceAll("'", "\'");
                                String pec = ((CustomEditText) findViewById(R.id.pec_et_p)).getText().toString().replaceAll("'", "\'");
    ...
    public void openModifyMode(ClientInfo client)
    {
        ...
        fidelity_code_text.setText(String.valueOf(client.getFidelity_id()));
        Fidelity clientFidelity = dbA.fetchFidelityById(client.getFidelity_id());
        show_fidelity_credit.setText(String.valueOf(clientFidelity.getValue()));
    ...
    private void setupAddFidelityCreditPopup()
    {
        ...
        final View popupView = inflater.inflate(R.layout.add_fidelity_package_popup, null);
        final PopupWindow popupWindow = new PopupWindow(
                popupView,
                RelativeLayout.LayoutParams.MATCH_PARENT,
                RelativeLayout.LayoutParams.MATCH_PARENT);
        ...
        popupView.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                EditText fidelity_package_creditAmount_et = popupView.findViewById(R.id.fidelity_package_creditAmount_et);
                EditText fidelity_package_price_et = popupView.findViewById(R.id.fidelity_package_price_et);
                ...
                if (creditAmount_input.isEmpty() && price_input.isEmpty())
                    { popupWindow.dismiss(); }

                // else, we have to check if the input is correct
                // but first, check that if one field is empty, the other is not
                else if (creditAmount_input.isEmpty() || price_input.isEmpty())
                    { Toast.makeText(ClientsActivity.this, "Please input both a credit amount and a price", Toast.LENGTH_LONG).show(); }
                ...
                else if (StaticValue.blackbox)
                {
                    ...
                    params.add(new BasicNameValuePair("title", String.format("fidelity credit (%s)", creditAmount_input)));
    ...
    public void saveFidelityPackageBill(FidelityPackage fidelityPackage)
    {
        ...
        creditProduct.setTitle(String.format("fidelity credit (%d)", fidelityPackage.getCreditAmount() ));
        ...
        Gson gson = new Gson();
        ArrayList cp = new ArrayList<CashButtonLayout>(); cp.add(creditProduct);
        ArrayList cust = new ArrayList<Customer>(); cust.add(thisClient);
