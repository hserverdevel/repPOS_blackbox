...
public class ReservationsActivity extends AppCompatActivity implements HttpHandler.AsyncResponse
{
    ...
    private ImageButton adultsPlus;
    private ImageButton childrenPlus;
    private ImageButton disabledPlus;
    private ImageButton adultsMinus;
    private ImageButton childrenMinus;
    private ImageButton disabledMinus;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        searchReservations = (CustomButton)findViewById(R.id.search_reservations_button);
        search_et = (CustomEditText)ReservationsActivity.this.findViewById(R.id.search_reservation_et);
        insertReservations = (CustomButton)findViewById(R.id.insert_reservation_button);
        setReservationTime = (CustomButton)findViewById(R.id.set_reservation_time_button);
        setReservationDate = (CustomButton)findViewById(R.id.set_reservation_date_button);
        reservationsTV = (CustomTextView)findViewById(R.id.title_tv);
        newReservationTV = (CustomTextView)findViewById(R.id.title_right_tv);
        telephoneNumber = (CustomEditText)findViewById(R.id.new_res_input_telephone);
        hline = (View)findViewById(R.id.hline4_right);

        reservations_list_rv = (RecyclerView)findViewById(R.id.reservations_rv);
        reservations_list_rv.setLayoutManager(new LinearLayoutManager(context,
                                        ...
                                        new TimerTask() {
                                            ...
                                            public void run() {
                                                runOnUiThread(new Runnable(){
                                                    ...
                                                    @Override
                                                    public void run(){
                                                        waitingListAdapter.searchWaitingListElement(s.toString());
                                                    }
                                                });
                                            }
                                        },
    ...
    public void switchMode(){
        ...
        divider.setDrawable(ContextCompat.getDrawable(getBaseContext(),
                R.drawable.divider_black_for_reservation));
    ...
    public void addNewReservationFromServer( Reservation res){
        CustomEditText newName = (CustomEditText)findViewById(R.id.new_res_input_name);
        CustomEditText newSurname = (CustomEditText)findViewById(R.id.new_res_input_surname);
        ...
        date = "";
        time = "";
        RelativeLayout.LayoutParams ll = (RelativeLayout.LayoutParams) newResLayout.getLayoutParams();
        ll.setMarginStart((int) (20 * density));
        ll.height = (int) (51 * density);
        ll.width = (int) (350 * density);
        newResLayout.setLayoutParams(ll);
        ((CustomTextView) findViewById(R.id.new_reservation_type)).setText(
                resources.getString(R.string.adults_children_disabled, adults, children, disabled));

        throwConfirmPopup("new");
    }

    public void setupNewReservationsButtons(){
        adultsPlus = (ImageButton)findViewById(R.id.adults_plus_button);
        adultsMinus = (ImageButton)findViewById(R.id.adults_minus_button);
        childrenPlus = (ImageButton)findViewById(R.id.children_plus_button);
        childrenMinus = (ImageButton)findViewById(R.id.children_minus_button);
        disabledPlus = (ImageButton)findViewById(R.id.disabled_plus_button);
        disabledMinus = (ImageButton)findViewById(R.id.disabled_minus_button);
        CustomEditText newName = (CustomEditText)findViewById(R.id.new_res_input_name);
        CustomEditText newSurname = (CustomEditText)findViewById(R.id.new_res_input_surname);
        CustomEditText telephoneNumber = (CustomEditText)findViewById(R.id.new_res_input_telephone);
        ...
        newSurname.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                StringBuilder sb = new StringBuilder();
                if(keyEvent.getKeyCode() == KeyEvent.KEYCODE_ENTER){
                    name = newName.getText().toString();
                    if(!newSurname.getText().equals("")) {
                        surname = newSurname.getText().toString();
                    }
                }
                InputMethodManager imm = (InputMethodManager) context.getSystemService(INPUT_METHOD_SERVICE);
        ...
        setReservationDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dPicker = new DatePickerDialog(ReservationsActivity.this, R.style.DatePickerTheme,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
                                ...
                                if(i != year || i1 != month || i2 != day) {
                                    findViewById(R.id.new_reservation_date).setVisibility(View.VISIBLE);
                                    RelativeLayout.LayoutParams ll = (RelativeLayout.LayoutParams)newResLayout.getLayoutParams();
                                    ll.setMarginStart((int)(20*density));
                                    ll.height = (int) (51*density);
                                    ...
                                    if((i1+1) < 10) {
                                        if (i2 < 10)
                                            ((CustomTextView) findViewById(R.id.new_reservation_date))
                                                    .setText("0" + i2 + "-0" + (i1+1) + "-" + (i-2000));
                                        else
                                            ((CustomTextView) findViewById(R.id.new_reservation_date))
                                                    .setText(i2 + "-0" + (i1+1) + "-" + (i-2000));
                                    }
                                    else {
                                        if (i2 < 10)
                                            ((CustomTextView) findViewById(R.id.new_reservation_date))
                                                    .setText("0" + i2 + "-" + (i1+1) + "-" + (i-2000));
                                        else
                                            ((CustomTextView) findViewById(R.id.new_reservation_date))
                                                    .setText(i2 + "-" + (i1+1) + "-" + (i-2000));
                                    }
                                }
                            }
                        }, year, month, day);
        ...
        setReservationTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(ReservationsActivity.this,4, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        ...
                        ((CustomTextView) findViewById(R.id.new_reservation_time)).setText(formattedHours + ":"
                                + formattedMinutes);
                    }
                    ...
                    if(!name.equals("") && !surname.equals("")){
                        if(!date.equals("") && !time.equals("")){
                            if(adults != 0){
                                ...
                                res.setReservation_date(date);
                                res.setReservation_time(time);
                                res.setStatus(0);
                                if(!telephoneNumber.getText().toString().equals(""))
                                    res.setTelephone(Long.parseLong(telephoneNumber.getText().toString()));

                                if(StaticValue.blackbox){
                                    List<NameValuePair> params = new ArrayList<NameValuePair>(2);
                                    Gson gson = new Gson();
                                    String reservation = gson.toJson(res);
                                    params.add(new BasicNameValuePair("reservation", reservation));
                                ...
                                Toast.makeText(context, R.string.please_add_at_least_one_adult, Toast.LENGTH_SHORT).show();
                            }
                        }
                        else{
                            Toast.makeText(context, R.string.insert_a_valid_reservation_time, Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        Toast.makeText(context, R.string.insert_a_valid_client_name, Toast.LENGTH_SHORT).show();
                    }
                }
                else if(mode == WAITING_LIST_MODE){
                    if(!name.equals("")
                        ...
                        if(adults != 0){
                            ...
                            res.setArrivalTime(now.getTime());
                            res.setStatus(0);
    ...
    public void changeActivity(){
        ...
        if (number + 1 > numberBill + 1) {
            ...
            orderNumber = (numberBill + 1);
        }

        Log.d("ORDER NUMBER", orderNumber + "");
        intent.putExtra("billId", billId);
        intent.putExtra("userId", userId);
        intent.putExtra("userType", userType);
        intent.putExtra("tableNumber", tableNumber);
        if(orderNumber == -1 || orderNumber == -11)
            orderNumber = dbA.getMaxOrderId(TimerManager.getSessionTimeStart()) + 2;
        Log.d("NEW ORDER NUMBER", orderNumber + "");
    ...
    public void openModifyMode(Reservation res){
        ...
        ((CustomTextView)findViewById(R.id.new_reservation_date)).setText(res.getReservation_date());
        ((CustomTextView)findViewById(R.id.new_reservation_time)).setText(res.getReservation_time());
        if(res.getTelephone() != 0)
            ((CustomEditText)findViewById(R.id.new_res_input_telephone)).setText(res.getTelephone() + "");
        if(res.getChildren() != 0 || res.getDisabled() != 0){
            ((CustomTextView)findViewById(R.id.new_reservation_type)).setText(
                    resources.getString(R.string.adults_children_disabled, res.getAdults(), res.getChildren(), res.getDisabled()));
        }
        else
            ((CustomTextView)findViewById(R.id.new_reservation_type)).setText(resources.getString(R.string._adults, res.getAdults()));
        ...
        ((CustomButton)findViewById(R.id.insert_reservation_button)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                throwConfirmPopup("modified");

                ((CustomTextView)findViewById(R.id.title_right_tv)).setText(R.string.new_reservation);
                ((CustomButton)findViewById(R.id.insert_reservation_button)).setText(R.string.insert_reservation);
                ((CustomTextView)findViewById(R.id.new_reservation_name)).setText(R.string.new_reservation);
                ((CustomTextView)findViewById(R.id.new_reservation_date)).setVisibility(GONE);
                ((CustomTextView)findViewById(R.id.new_reservation_date)).setText("");
                ((CustomTextView)findViewById(R.id.new_reservation_time)).setText("00:00");
                ((CustomEditText)findViewById(R.id.new_res_input_telephone)).setText("");
                newName.setText("");
                newSurname.setText("");
                name = "";
                surname = "";
