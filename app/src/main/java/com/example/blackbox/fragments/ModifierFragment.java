...
public class ModifierFragment extends Fragment {
    ...
    public Boolean getAlreadyShowingModifier() {return alreadyShowingModifier;}

    public void setAlreadyShowingModifier(Boolean b){alreadyShowingModifier = b;}

    private static Boolean modify = false;

    public static Boolean getModify() { return modify;}

    public static void setModify(Boolean b){ modify = b;}
