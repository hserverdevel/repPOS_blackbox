...
public class GridAdapter extends Adapter<ViewHolder> implements ItemTouchHelperAdapter, AdapterView.OnItemSelectedListener
{
    ...
    {
        if (buttons.get(position).getID() == -11)
        { return -11; }
    ...
    private void addPopupWindow()
    {
        ...
        btnCategory.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                ((CustomButton) popupView.findViewById(R.id.goToCategory)).setText(resources.getString(R.string.goTo_, resources.getString(getCurrentLevelName())));
                ((CustomButton) popupView.findViewById(R.id.deleteCategory)).setText(resources.getString(R.string.delete_, resources.getString(getCurrentLevelName())));
                ...
                btnOk.setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        {
                            Toast.makeText(context, resources.getString(R.string.max_number_of__reached, resources.getString(getCurrentLevelName())), Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            ((CustomTextView) popupView.findViewById(R.id.category_tv)).setText(getCurrentLevelName());
                            ...
                            if (!title.equals(""))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        dbA.execOnDb("INSERT INTO button (title, subtitle, img_name, color, position, catID, isCat, printer) " + "VALUES(\"" + title.replaceAll("'", "\'") + "\",\"" + subtitle.replaceAll("'", "\'") + "\",\"" + chosenIcon + "\"," + color + "," + buttons.size() + "," + currentCatID + ", 1, " + printerId + ")");
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    dbA.queryToDb("INSERT INTO button (title, subtitle, img_name, color, position, " + "price, vat, catID, isCat, printer) " + "VALUES(\"" + title.replaceAll("'", "\'") + "\",\"" + subtitle.replaceAll("'", "\'") + "\",\"\"," + color + "," + buttons.size() + "," + price + "," + vat1 + "," + currentCatID + ", 0, " + printerId + ")");
                                    getCurrentCatButtonSet(currentCatID);
        ...
        btnOk.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if (!colorState)
                {
                    ...
                    else if (!((EditText) popupView.findViewById(R.id.prodTitleInsert)).getText().toString().equals("") && !((EditText) popupView.findViewById(R.id.prodPriceInsert)).getText().toString().equals(""))
                    {
                        String title = ((EditText) popupView.findViewById(R.id.prodTitleInsert)).getText().toString();
                        String subtitle = ((EditText) popupView.findViewById(R.id.prodSubTitleInsert)).getText().toString();
                        ...
                        else
                        {
                            ...
                            if (b.getID() > 0)
                            {
                                dbA.execOnDb("UPDATE button SET title = \"" + title.replaceAll("'", "\'") + "\", subtitle = \"" + subtitle.replaceAll("'", "\'") + "\", img_name = \"\", color = " + color + ", " + "barcode='" + barcode + "'," + "price = " + price + ", vat = " + vat1 + ", printer = " + printerId + " WHERE " + DatabaseAdapter.KEY_ID + " = " + b.getID() + ";");
                            }
                            else
                            {
                                dbA.queryToDb("INSERT INTO button (title, subtitle, img_name, color, position, " + "price, vat, catID, isCat, printer, barcode) " + "VALUES(\"" + title.replaceAll("'", "\'") + "\",\"" + subtitle.replaceAll("'", "\'") + "\",\"\"," + color + "," + buttons.size() + "," + price + "," + vat1 + "," + currentCatID + ", 0, " + printerId + ", '" + barcode + "')");
                            }
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        dbA.execOnDb("UPDATE button SET title = \"" + title.replaceAll("'", "\'") + "\", subtitle = \"" + subtitle.replaceAll("'", "\'") + "\", img_name = \"\", color = " + color + ", " + "price = " + price + ", vat =" + vat1 + " WHERE " + DatabaseAdapter.KEY_ID + " = " + b.getID() + ";");
                        StatusInfoHolder sh = new StatusInfoHolder();
                        sh.setCurrent_category_id(currentCatID);
                        sh.setDept_level(deepnessLevel);
                        sh.setPrevious_category_title(currentCatTitle);
    ...
    private void catSettingsPopupWindow(final View grid_element)
    {
        ...
        btnOk.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    dbA.execOnDb("UPDATE button SET title = \"" + title.replaceAll("'", "\'") + "\", subtitle = \"" + subtitle.replaceAll("'", "\'") + "\", img_name = \"" + icon + "\"," + "color = " + color + " , printer= " + printerId + " WHERE id = " + b.getID() + "");
    ...
    public void okBehaviourInProductSetting(View popupView, PopupWindow popupWindow)
    {
        ...
        else if (!((EditText) popupView.findViewById(R.id.prodTitleInsert)).getText().toString().equals("") && !((EditText) popupView.findViewById(R.id.prodPriceInsert)).getText().toString().equals(""))
        {
            ...
            else
            {
                ...
                dbA.queryToDb("INSERT INTO button (title, subtitle, img_name, color, position, " + "price, vat, catID, isCat) " + "VALUES(\"" + title.replaceAll("'", "\'") + "\",\"" + subtitle.replaceAll("'", "\'") + "\",\"\"," + color + "," + buttons.size() + "," + price + "," + iva + "," + currentCatID + ", 0)");
                getCurrentCatButtonSet(currentCatID);
                if (!colorState)
                { popupWindow.dismiss(); }
                else
    ...
    public void getCurrentCatButtonSet(int catID)
    {
        ...
        { big_plus_button.setImg("addplussubbutton"); }
    ...
    private void setupIconSelector(final View view)
    {
        ...
        recyclerView.setAdapter(new Adapter()
        {
            ...
            public void onBindViewHolder(ViewHolder holder, final int position)
            {
                ...
                int width = (position % 8 == 0 || position % 8 == 7)
                            ? (int) (124 * density)
                            : (int) (122 * density);
                ...
                iconHolder.view.setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        if (chosenIconHolder != null)
                        { chosenIconHolder.iconPick.setVisibility(GONE); }
