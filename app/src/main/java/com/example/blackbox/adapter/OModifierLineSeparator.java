...
public class OModifierLineSeparator extends RecyclerView.ItemDecoration {
    private final float density;
    private int offset;
    private Context context;
    private Drawable divider;

    public OModifierLineSeparator(Context c, int offset) {
        this.offset = offset;
        this.context = c;
    ...
    public void getItemOffsets(Rect outRect, View view,
        ...
        OModifierAdapter.OModifier m = (OModifierAdapter.OModifier) view.getTag();
