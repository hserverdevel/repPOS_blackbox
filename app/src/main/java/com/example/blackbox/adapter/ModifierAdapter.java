...
//                border.setStroke(3, context.getColor(R.color.yellow)); // yellow border
                ...
                plusbutton.view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(!addModifierActive)firePopupWindow(v);
                    }
                });
                break;
            default:
   ...
   //             border.setStroke(3, context.getColor(R.color.yellow)); // gray border
    ...
    private void firePopupWindow(View v){
        ...
        if(m.getID()== -11) popupWindow(v,true);
        else popupWindow(v,false);
    }
    ...
    private void popupWindow(View v, final boolean isBeingAdded){
        ...
        if(!isBeingAdded) title.setText(m.getTitle());
        if(!isBeingAdded) priceContainer.setText(String.valueOf(m.getPrice()));
        ...
        btnOk.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(((EditText)popupView.findViewById(R.id.modPriceInsert)).getText().toString().equals("")) price = 0.0f;
                else price = Float.valueOf(((EditText)popupView.findViewById(R.id.modPriceInsert)).getText().toString());
        ...
        deleteModifier.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(isBeingAdded) Toast.makeText(context,R.string.modifier_has_not_been_created_yet,Toast.LENGTH_SHORT).show();
                else{
    ...
    public static class Modifier {
        ...
        public static ArrayList<Modifier> fromJsonArray(JSONArray jsonObject) {
            Gson gson = new Gson();
            Type type = new TypeToken<List<Modifier>>(){}.getType();
