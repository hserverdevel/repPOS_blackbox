...
public class CustomTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private final static int FRANKLIN_GOTHIC_MEDIUM_CD = 13;
    private final static int FRANKLIN_GOTHIC_HARD = 14;
    private final static int FRANKLIN_GOTHIC_DEMIOBLIQUE = 15;
    ...
    public void setTypeface(int typeface){
        switch(typeface){
            ...
            case FRANLIN_GOTHIC_BOOK_ITALIC:
                ...
                break;
            case FRANKLIN_GOTHIC_MEDIUM_CD:
                setTypeface(Typeface.createFromAsset(context.getAssets(),"fonts/FRANGMC_.ttf"));
                break;

            case FRANKLIN_GOTHIC_HARD:
                setTypeface(Typeface.createFromAsset(context.getAssets(),"fonts/FRANGH__.ttf"));
                break;

            case FRANKLIN_GOTHIC_DEMIOBLIQUE:
                setTypeface(Typeface.createFromAsset(context.getAssets(),"fonts/FRANGDO_.TTF"));
                break;
