...
public class ModifiersGroupLineSeparator extends RecyclerView.ItemDecoration {
    private final float density;
    private int offset;
    private Context context;
    private Drawable divider;

    public ModifiersGroupLineSeparator(Context c, int offset) {
        this.offset = offset;
        this.context = c;
    ...
    public void getItemOffsets(Rect outRect, View view,
        ...
        ModifiersGroupAdapter.ModifiersGroup g = (ModifiersGroupAdapter.ModifiersGroup) view.getTag();
